...
def get_args():
    ...
    show_parser.add_argument(
        'src', type=str, help='Path to a base/multireso index file.')
    show_parser.add_argument(
        '--arrow-files', action='store_true', help='Show arrow files only.')
    ...
    index_kits base -c /path/to/config.yaml -t /path/to/index.json
    """, formatter_class=argparse.RawTextHelpFormatter)
    base_parser.add_argument('-c', '--config', type=str,
    ...
    base_parser.add_argument('--work-dir', type=str,
    ...
    mo_parser.add_argument('--base-size', type=int, default=None,
                           help="Base size. Typically set as 256/512/1024 according to image size you train model.")
    ...
    mo_parser.add_argument('--align', type=int, default=16,
                           help="Used when --target-ratios is provided. Align size of source image height and width.")
